...
const sampleQuestions: Question[] = [
  ...
  {
    id: 2,
    question: 'Listen to the conversation and answer: What does the professor suggest?',
    type: 'listening',
    difficulty: 'hard',
    options: [
      'To submit the paper early',
  ...
  {
    id: 3,
    question: 'Choose the correct grammatical form: The students ____ studying for the exam.',
    type: 'structure',
    difficulty: 'easy',
    options: [
      'is',
    ...
    <div className="space-y-6 p-8 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and organize your TOEFL test questions</p>
        </div>
          <Link
